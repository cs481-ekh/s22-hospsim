...
* Meeting with Dr.Walters
  ...
  * Derek walked her through with what we have and what we dont have, in not so many words
  - [x]Derek will email Dr. Walters with the live link to our repo page to test and will reply with feedback
...
* Meeting with Dr.Walters
  ...
  * Andrew walked her through the implementation of the calendar and also suggested other improvements like adding a monthly budget. Dr walters was okay with that but    also wanted a two weeks budget display as well.
  * We asked Dr walters about adding more "?" being in front of every tooltip but she was okay with the way it is right now.
  * Dr. walters wants us to implement the functionality for adding staff every two weeks and extend it to months if we like.
  * Dr. walters also wants us to include show budget and show cal in a pop-up menu. So that we can include more settings and not clutter the page.
